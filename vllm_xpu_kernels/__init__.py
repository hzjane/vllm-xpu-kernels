...
LINEAR_KERNELS_AVAILABLE = find_spec(f"{__name__}._linear_C") is not None
if LINEAR_KERNELS_AVAILABLE:
...
FP16_KERNELS_AVAILABLE = find_spec(f"{__name__}._fp16_C") is not None
if FP16_KERNELS_AVAILABLE:
